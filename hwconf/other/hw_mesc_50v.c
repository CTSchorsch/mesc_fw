...
void hw_init_gpio(void) {
	...
	//HW Bugfix, map UART to front Panel, set PC12 and PC15 high-z
	...
	// Phase filters
	palSetPadMode(GPIOB, 7, PAL_MODE_OUTPUT_OPENDRAIN | PAL_STM32_OSPEED_HIGHEST);
	palSetPadMode(GPIOB, 8, PAL_MODE_OUTPUT_OPENDRAIN | PAL_STM32_OSPEED_HIGHEST);
	palSetPadMode(GPIOB, 9, PAL_MODE_OUTPUT_OPENDRAIN | PAL_STM32_OSPEED_HIGHEST);
	PHASE_FILTER_OFF();
	...
	palSetPadMode(GPIOB, 6, PAL_MODE_OUTPUT_OPENDRAIN | PAL_STM32_OSPEED_HIGHEST);
	CURRENT_FILTER_OFF();
	...
	palSetPadMode(GPIOC, 5, PAL_MODE_INPUT_ANALOG);
        ...
        terminal_register_command_callback( "double_pulse", "Start a double pulse test", 0, terminal_cmd_doublepulse);
#endif
