...
//Phase Filter on/off
#define PHASE_FILTER_OFF()		palSetPad(GPIOB, 7); palSetPad(GPIOB, 8); palSetPad(GPIOB, 9);
#define PHASE_FILTER_ON()		palClearPad(GPIOB, 7); palClearPad(GPIOB, 8); palClearPad(GPIOB, 9);

//current Filter on/off
#define CURRENT_FILTER_OFF()		palSetPad(GPIOB, 4); palSetPad(GPIOB, 5); palSetPad(GPIOB, 6);
#define CURRENT_FILTER_ON()		palClearPad(GPIOB, 4); palClearPad(GPIOB, 5); palClearPad(GPIOB, 6);
...
#define NTC_TEMP(adc_ind)		(1.0 / ((logf(NTC_RES(ADC_Value[adc_ind]) / 10000.0) / 3950.0) + (1.0 / 298.15)) - 273.15)
...
#define HW_ENC_EXTI_PINSRC		EXTI_PinSource9
#define HW_ENC_EXTI_CH			EXTI9_5_IRQn
#define HW_ENC_EXTI_LINE		EXTI_Line9
